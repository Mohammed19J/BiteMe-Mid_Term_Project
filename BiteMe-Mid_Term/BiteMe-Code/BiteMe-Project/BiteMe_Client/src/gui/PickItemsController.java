...
public class PickItemsController implements Initializable, IControl {
	...
	/**
	 * Validates if there is at least one selected ingredient in the ingredient
	 * table.
	 * 
	...
	/**
	 * Generates a string containing the notes for the selected item based on size,
	 * doneness, and ingredient exclusions.
	 * 
	...
	/**
	 * Updates the detail fields (size, doneness, and ingredients) based on the
	 * selected item.
	 * 
	...
	/**
	 * Starts the PickItemsController and sets up the user interface with the FXML
	 * file and CSS styles.
	 * 
	...
	public void start(Stage primaryStage) throws Exception {
		...
		primaryStage.setTitle("Pick Items Page");
	...
	/**
	 * Represents an ingredient with a selectable checkbox. This inner class manages
	 * the ingredient's name and its selected state.
	 */
	public static class IngredientEntry {
		/**
		 * A string property representing the name of the ingredient.
		 */
		private final SimpleStringProperty ingredient;
		/**
		 * A boolean property representing whether the ingredient is selected or not.
		 */
		private final SimpleBooleanProperty selected;

		/**
		 * Constructs an IngredientEntry object with the specified ingredient name and
		 * selected state.
		 * 
		 * @param ingredient The name of the ingredient.
		 * @param selected   The initial selected state of the ingredient.
		 */
	...
	/**
	 * Represents an order item in the cart. This inner class manages the order
	 * item's name, notes, quantity, and cost.
	 */
	public static class OrderItemEntry {
		/**
		 * A string property representing the name of the order item.
		 */
		private final SimpleStringProperty name;
		/**
		 * A string property representing the notes associated with the order item.
		 */
		private final SimpleStringProperty notes;
		/**
		 * An integer property representing the quantity of the order item.
		 */
		...
		/**
		 * Constructs an OrderItemEntry object with the specified name, notes, quantity,
		 * and item cost.
		 * 
		 * @param name     The name of the order item.
		 * @param notes    Additional notes for the order item.
		 * @param quantity The quantity of the order item.
		 * @param itemCost The cost of the individual item.
		 */
