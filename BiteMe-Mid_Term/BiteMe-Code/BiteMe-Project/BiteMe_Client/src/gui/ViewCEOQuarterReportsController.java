...
/**
 * Controller for the CEO Quarter Reports view. Manages the user interface and
 * interactions related to viewing and comparing quarterly reports of different
 * restaurant branches.
 * 
 * @version 5.0
...
public class ViewCEOQuarterReportsController implements Initializable, IControl {
	/**
	 * Tracks the current index of the restaurant being displayed in the first
	 * chart.
	 */
	private int currentRestaurantIndex1 = 0;
	/**
	 * Tracks the current index of the restaurant being displayed in the second
	 * chart.
	 */
	private int currentRestaurantIndex2 = 0;
	/**
	 * Holds the list of restaurant IDs for the first report.
	 */
	private List<Integer> restaurantIDs1;
	/**
	 * Holds the list of restaurant IDs for the second report.
	 */
	private List<Integer> restaurantIDs2;
	/**
	 * Button to navigate to the previous restaurant's data in the first report.
	 */
	@FXML
	private Button leftArrowBtn1;
	/**
	 * Button to navigate to the next restaurant's data in the first report.
	 */
	@FXML
	private Button rightArrowBtn1;
	/**
	 * Label to display the current restaurant ID for the first report.
	 */
	@FXML
	private Label restaurantIdLbl1;
	/**
	 * Button to navigate to the previous restaurant's data in the second report.
	 */
	@FXML
	private Button leftArrowBtn2;
	/**
	 * Button to navigate to the next restaurant's data in the second report.
	 */
	@FXML
	private Button rightArrowBtn2;
	/**
	 * Label to display the current restaurant ID for the second report.
	 */
	@FXML
	...
	/**
	 * The BranchReports object associated with the first ComboBox.
	 */
	private BranchReports thisBR1;
	/**
	 * The BranchReports object associated with the second ComboBox.
	 */
	private BranchReports thisBR2;
	/**
	 * The list of QuarterReport objects for the first quarter report.
	 */
	private ArrayList<QuarterReport> qr1;
	/**
	 * The list of QuarterReport objects for the second quarter report.
	 */
	...
	/**
	 * Initializes the ComboBox for selecting the year and quarter for the first
	 * report.
	 *
	 * @param event The event triggered by the user's action.
	 */
	...
	/**
	 * Initializes the ComboBox for selecting the year and quarter for the second
	 * report.
	 *
	 * @param event The event triggered by the user's action.
	 */
	...
	/**
	 * Retrieves the BranchReports object based on the selected branch ID.
	 *
	 * @param branchID The ID of the branch for which the reports are to be
	 *                 retrieved.
	 * @return The BranchReports object corresponding to the selected branch ID, or
	 *         null if not found.
	 */
	...
	/**
	 * Populates the year ComboBox with available years from the provided
	 * BranchReports object.
	 *
	 * @param yearComboBox  The ComboBox to be populated with the years.
	 * @param branchReports The BranchReports object containing the available years.
	 */
	...
	/**
	 * Reset branch data on branchID switch for first bar and comboboxes.
	 */
	...
	/**
	 * Reset branch data on branchID switch for second bar and comboboxes.
	 */
	...
	/**
	 * Displays the previous restaurant's data in the first report.
	 *
	 * @param event The event triggered by the user's action.
	 */
	@FXML
	...
	/**
	 * Displays the next restaurant's data in the first report.
	 *
	 * @param event The event triggered by the user's action.
	 */
	@FXML
	...
	/**
	 * Displays the previous restaurant's data in the second report.
	 *
	 * @param event The event triggered by the user's action.
	 */
	@FXML
	...
	/**
	 * Displays the next restaurant's data in the second report.
	 *
	 * @param event The event triggered by the user's action.
	 */
	@FXML
	...
	/**
	 * Updates arrow buttons state based on selected branch for first bar chart.
	 */
	...
	/**
	 * Updates arrow buttons state based on selected branch for second bar chart.
	 */
